...
// const updateUSCountyBoundaries = require("../tools/update-us-county-boundaries");
...
//       "https://public.opendatasoft.com/api/explore/v2.1/catalog/datasets/us-county-boundaries/records?select=geo_shape%2C%20namelsad&where=stusab%20%3D%20'FL'&limit=8"
//     );
...
//     const jsonFilePath = "./temp/county-boundaries.json"; // File path to write to

//     // Write file to specified path
//     // fs.writeFile(jsonFilePath, coordinatesString, (err) => {
...
//     //   }
//     // });
//     await writeFile(jsonFilePath, coordinatesString).then((result) => {
//       res.status(200).send({
//         message: "Sucessfully got coordinates 1",
//       });
//     });
...
const updateCoordinates = async (req, res) => {
  try {
    ...
    exec("node ../tools/update-us-county-boundaries.js");
    // Send a 200 OK response with a success message
    res.status(200).send({
      message: "Sucessfully got coordinates",
    });
